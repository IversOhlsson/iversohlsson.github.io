...
export const SCENARIOS: Scenario[] = [
  {
    ...
    scenes: [
      ...
      { kind: 'record', where: 'internal', system: 'Orders', title: 'An agent fills in the order inside your system', caption: 'The fields you care about, where they belong. Nothing copied by hand.', ms: 9000,
      ...
      { kind: 'phone', where: 'phone', system: 'Your phone', title: 'Anna gets a notification. One tap decides.', caption: 'The agent suggests a date from the usual lead time. A person decides.', ms: 10000,
      ...
      { kind: 'log', where: 'internal', system: 'Activity', title: 'Everything is on the record', caption: 'What arrived, what the agents read, who decided.', ms: 7000,
        entries: [{ who: 'Email', what: 'PO-4471.pdf received from Bergström Verkstad' }, { who: 'Agent', what: 'Read the order. 4 of 5 fields filled. Delivery date missing.' }, { who: 'Agent', what: 'Suggested 30 Oct 2026 from the usual lead time' }, { who: 'Anna', what: 'Chose 30 Oct 2026 from her phone' }, { who: 'System', what: 'Order planned, confirmation published to the customer portal' }] },
    ],
  },
  {
    ...
    scenes: [
      ...
      { kind: 'readmany', where: 'internal', system: 'Readers', title: 'One reader agent per document', caption: 'Six documents read at once. Every fact keeps a link to the page it came from.', ms: 7500,
  ...
  },
  {
    ...
    scenes: [
      ...
      { kind: 'record', where: 'internal', system: 'Claims', title: 'An agent prepares the claim file', caption: 'Policy checked, estimate compared with the report. One thing is missing.', ms: 9000,
  ...
  },
  {
    ...
    scenes: [
      ...
      { kind: 'phone', where: 'phone', system: 'Your phone', title: 'The fleet manager is told, not alarmed', caption: 'The agent checks the delivery plan first. Nothing is late yet, so the message says so.', ms: 9000,
      ...
      { kind: 'log', where: 'internal', system: 'Activity', title: 'Everything is on the record', caption: 'Including the 18 minutes offline, with every reading in place.', ms: 7000,
        entries: [{ who: 'Truck 12', what: 'Lost connection 13:02. Recording locally.' }, { who: 'Agent', what: 'Checked the plan: no delivery at risk. Told Johan, suggested waiting.' }, { who: 'Johan', what: 'Chose to wait 15 minutes' }, { who: 'Truck 12', what: 'Back online 13:20. 42 readings synced.' }, { who: 'System', what: 'ETA updated on the customer tracking page' }] },
    ],
  },
]
